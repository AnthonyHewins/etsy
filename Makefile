...
# Open API
#==============================
regen: ## Regenerate the open API spec
	oapi-codegen -package etsy -generate 'types,client' 3.0.0.json > spec.go

download: ## Download a copy of the open API spec
	curl https://www.etsy.com/openapi/generated/oas/3.0.0.json > 3.0.0.json
